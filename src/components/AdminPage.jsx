    ...
    <div className="w-full max-w-7xl px-8 grid grid-cols-2 gap-12 min-h-screen py-8 mx-auto text-white">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className={`${borderStyle} ${bgStyle} p-6 flex flex-col gap-4`} style={forcedRounded}>
          ...
          <div className="border-[4px] border-black/40 p-2 bg-black/40 font-mono text-base" style={{ borderRadius: '12px' }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb { background: #2e1065; border-radius: 9999px; }
      `}} />
    </div>
  );
}